...
public class ApplicationVerificationController {
    private static final String VERIFICATION_REQUEST_LOG = "Received request to verify application form.";
    ...
    private static final String VERIFICATION_SUCCESS_LOG = "Application form verification successful.";
