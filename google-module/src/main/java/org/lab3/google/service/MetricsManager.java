...
public final class MetricsManager {
  ...
  private static final String SUCCESSFUL_REQUESTS_NAME =
      "google_module_requests_success_total";
  private static final String FAILED_REQUESTS_NAME =
      "google_module_requests_failed_total";
  private static final String REQUEST_DURATION_NAME =
      "google_module_request_duration_seconds";
  private static final String FORMS_CREATED_NAME =
      "google_module_forms_created_total";
  private static final String SHEETS_CREATED_NAME =
      "google_module_sheets_created_total";
  private static final String TABS_CREATED_NAME =
      "google_module_sheet_tabs_created_total";
  private static final String REVENUE_UPDATES_NAME =
      "google_module_revenue_updates_total";
  private static final String TOP_UPDATES_NAME =
      "google_module_top_updates_total";
  ...
  public void recordTabsCreated(final int count) {
    ...
    for (String operation : operations) {
      operationCounters.put(
          ...
          Counter.build()
              ...
              .register());
      LOGGER.info("Prometheus counter 'google_module_operation_"
          + operation + "_total' registered.");
    }
  }
  ...
  public void recordRequest(final String operation, final boolean success) {
    totalRequests.inc();
    LOGGER.info("Total requests count incremented. Current total: "
        + totalRequests.get());
    if (success) {
      successfulRequests.inc();
      LOGGER.info("Successful requests count incremented. Current successful: "
          + successfulRequests.get());
    } else {
      failedRequests.inc();
      LOGGER.error("Failed requests count incremented. Current failed: "
          + failedRequests.get());
    }
    ...
    if (operationCounter != null) {
      ...
      LOGGER.info("Operation '" + operation + "' count incremented. Current count: "
