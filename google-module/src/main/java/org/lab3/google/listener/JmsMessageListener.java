...
public final class JmsMessageListener implements MessageEndpoint, MessageListener {
  ...
  /**
   * Constructs a new JmsMessageListener.
   *
   * @param googleConnectionParam the Google connection
   * @param connectionFactoryParam the connection factory
   */
  public JmsMessageListener(
      final GoogleConnection googleConnectionParam,
      final ConnectionFactory connectionFactoryParam) {
    this.googleConnection = googleConnectionParam;
    this.connectionFactory = connectionFactoryParam;
  }

  @Override
  public void beforeDelivery(final java.lang.reflect.Method method) {
    // Intentionally empty
  }
