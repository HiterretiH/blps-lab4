...
public class GoogleSheetService {
    ...
    private static final String REVENUE_SHEET_CREATION_LOG = "Revenue sheet creation request sent for user ID: ";
    ...
    private static final String GOOGLE_CONNECTION_FAILED_LOG = "Google connection failed for user ID: ";
    ...
    private static final String APP_SHEETS_CREATION_LOG = "App sheets creation request sent for app: ";
    ...
    public String createRevenueSheet(int userId) throws OAuthException {
        ...
        GoogleSheetRequestWithData request = new GoogleSheetRequestWithData(
                googleEmail,
                sheetTitle,
                List.of(ID_COLUMN, APPLICATION_COLUMN, ADS_REVENUE_COLUMN,
                        DOWNLOAD_REVENUE_COLUMN, PURCHASES_REVENUE_COLUMN, TOTAL_REVENUE_COLUMN),
                appData
        );

        googleTaskSender.sendSheetCreationRequest(userId, request);
        logger.info(REVENUE_SHEET_CREATION_LOG + userId + TO_EMAIL_LOG + googleEmail + TITLE_LOG + sheetTitle);
    ...
    public String addAppSheets(int userId, int appId) {
        ...
        try {
            ...
            logger.error(GOOGLE_CONNECTION_FAILED_LOG + userId + REASON_LOG + oAuthException.getMessage());
