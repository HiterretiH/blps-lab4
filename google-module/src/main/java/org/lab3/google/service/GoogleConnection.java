...
public interface GoogleConnection extends AutoCloseable {
  ...
  void updateGoogleSheet(String sheetId, List<List<Object>> data)
      throws IOException;

  String createGoogleForm(String title, Map<String, String> fields)
      throws IOException;

  String createRevenueSpreadsheetWithData(
      String title,
      List<String> headers,
