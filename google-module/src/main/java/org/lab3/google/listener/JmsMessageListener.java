...
public class JmsMessageListener implements MessageEndpoint, MessageListener {
    ...
    private String processMessage(String operation, String content, Message message) throws JMSException, IOException {
    ...
    private String processCreateFormOperation(String content, Message message) throws IOException, JMSException {
