...
public class InAppPurchaseService {
    ...
    private static final String SAME_COUNT_ERROR = "The number of titles, prices, and descriptions must be the same.";
    ...
    private static final String LINK_REQUEST_LOG = "Linking InAppPurchases to MonetizedApplication ID: ";
    ...
    private static final String NULL_PURCHASES_LOG = " InAppPurchases with null MonetizedApplication.";
    ...
    @Autowired
    public InAppPurchaseService(InAppPurchaseRepository inAppPurchaseRepository,
    ...
    public List<InAppPurchase> createInAppPurchases(List<String> titles, List<String> descriptions, List<Double> prices) {
        ...
        logger.info(CREATE_REQUEST_LOG + titlesCount + DESCRIPTIONS_COUNT_LOG + descriptionsCount +
                PRICES_COUNT_LOG + pricesCount);
        ...
        try {
            if (titles == null || descriptions == null || prices == null ||
                    titles.size() != prices.size() || descriptions.size() != prices.size()) {
    ...
    public List<InAppPurchase> linkMonetizedAppToPurchases(int monetizedApplicationId) {
        ...
        logger.info(LINK_SUCCESS_LOG + purchases.size() + PURCHASES_TO_APP_LOG + monetizedApplicationId);
        return purchases;
    }
}
