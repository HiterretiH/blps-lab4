...
public class VerificationLogService {
    ...
    @Autowired
    public VerificationLogService(VerificationLogRepository verificationLogRepository, Logger logger) {
        this.verificationLogRepository = verificationLogRepository;
        this.logger = logger;
    }

    public VerificationLog createVerificationLog(boolean securityCheckPassed, boolean policyCheckPassed,
                                                 boolean adsCheckPassed, String logMessage) {
