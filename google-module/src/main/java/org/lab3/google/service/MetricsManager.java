...
public final class MetricsManager {
  ...
  private MetricsManager() {
    ...
    topUpdates =
        Counter.build().name(TOP_UPDATES_NAME).help("Total number of top updates").register();
    ...
    for (String operation : operations) {
      operationCounters.put(
          ...
          Counter.build()
              ...
              .register());
      LOGGER.info(
          "Prometheus counter 'google_module_operation_" + operation + "_total' registered.");
    }
  }
  ...
  public void recordRequest(final String operation, final boolean success) {
    ...
    if (success) {
      ...
      LOGGER.info(
          "Successful requests count incremented. Current successful: " + successfulRequests.get());
    } else {
      failedRequests.inc();
    ...
    if (operationCounter != null) {
      ...
      LOGGER.info(
          "Operation '"
              + operation
              + "' count incremented. Current count: "
